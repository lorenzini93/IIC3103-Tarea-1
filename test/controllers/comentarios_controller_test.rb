...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { contenido: @comentario.contenido, noticia: @comentario.noticia, usuario: @comentario.usuario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { contenido: @comentario.contenido, noticia: @comentario.noticia, usuario: @comentario.usuario } }
